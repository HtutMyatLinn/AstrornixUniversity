    ...
    <div class="py-12">
        <div class="container mx-auto px-4 sm:px-6 md:px-12 text-center">
            ...
            <div class="max-w-lg mx-auto mb-10 relative">
                ...
                <img src="{{ asset('images/group.png') }}" alt="Search Icon" class="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 transition-all duration-300 ease-in-out">
            </div>
    ...
    <div class="text-left w-full md:w-1/2 mt-4">
        ...
        <p class="text-sm text-gray-500 mt-1">by <strong>Jonathan Shaw</strong></p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="flex flex-col items-center gap-6">
                        <div class="w-full md:w-3/4">
                            <img src="{{ asset('images/cy2.png') }}" alt="Ivy Athletes" class="w-full h-auto object-cover">
                        </div>
                        <div class="text-center w-full md:w-1/2 mt-4">
                            <a href="#" class="text-md md:text-lg font-semibold text-black hover:underline">Why Ivy Athletes Score in Careers →</a>
                            <p class="text-sm text-gray-700">How does undergraduate participation in varsity sports enhance career success?</p>
                    ...
                    <div class="flex flex-col items-center gap-6">
                        <div class="w-full md:w-3/4">
                            <img src="{{ asset('images/news.png') }}" alt="Medical Research" class="w-full h-auto object-cover">
                        </div>
                        <div class="text-center w-full md:w-1/2 mt-4">
                            <a href="#" class="text-md md:text-lg font-semibold text-black hover:underline">Enhancing Critical Care Through Medical Research →</a>
                            <p class="text-sm text-gray-700">How does undergraduate participation in varsity sports enhance career success?</p>
                            <p class="text-xs text-gray-500 mt-1">by <strong>Jonathan Shaw</strong></p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col items-center gap-6">
                        <div class="w-full md:w-3/4">
                            <img src="{{ asset('images/com.png') }}" alt="Tech Innovations" class="w-full h-auto object-cover">
                        </div>
                        <div class="text-center w-full md:w-1/2 mt-4">
                            <a href="#" class="text-md md:text-lg font-semibold text-black hover:underline">Tech Innovations in AI →</a>
                            <p class="text-sm text-gray-700">Exploring the latest advancements in artificial intelligence research.</p>
                            <p class="text-xs text-gray-500 mt-1">by <strong>Jonathan Shaw</strong></p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col items-center gap-6">
                        <div class="w-full md:w-3/4">
                            <img src="{{ asset('images/cs.png') }}" alt="Cybersecurity" class="w-full h-auto object-cover">
                        </div>
                        <div class="text-center w-full md:w-1/2 mt-4">
                            <a href="#" class="text-md md:text-lg font-semibold text-black hover:underline">Cybersecurity Trends →</a>
                            <p class="text-sm text-gray-700">How modern cybersecurity techniques are shaping the digital world.</p>
                            <p class="text-xs text-gray-500 mt-1">by <strong>Jonathan Shaw</strong></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-left mt-8">
                <button class="bg-[#5A7BAF] text-white py-2 px-4 rounded-md shadow-md hover:bg-blue-600 transition duration-300 ease-in-out">
